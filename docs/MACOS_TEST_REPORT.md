...
| 产物 | 大小 | SHA-256 |
| --- | ---: | --- |
| `文档OCR助手-macos-arm64.zip` | 241 MiB（`du`） | `9e615fd6ecea2f996cc5b372ebdf136124db4550bd1e3f9ce01806d2f3a7a5d9` |
| `文档OCR助手-macos-arm64.dmg` | 252 MiB（`du`） | `c8708279bf9843e310197c3668e3072ec82e6baba79e5d5658e4ef073343971f` |
...
- 首次使用截图识别时，需要用户在 macOS“隐私与安全性”中授予屏幕录制权限；权限弹窗无法在无人工确认的自动测试中完成。
